...
public class DatePicker extends LinearLayout implements IPick {
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        titleView = new TwoSelectTitleView(context);
        addView(titleView, llParams);

        monthView = new TwoSelectedMonthView(context);
    ...
    @Override
    public void setVailidDays(Date pBeginDate, Date pEndingDate, int pColor){
    	monthView.setVailidDays(pBeginDate,pEndingDate,pColor);
    }
}
